...
/***/ "./assets/js/admin/product-review/images.js":
/*!**************************************************!*\
  !*** ./assets/js/admin/product-review/images.js ***!
  \**************************************************/
...
const tourReviewImages = () => {
  ...
  (0,delegated_events__WEBPACK_IMPORTED_MODULE_1__.on)('click', '.tour-gallery-add', function (event) {
    event.preventDefault();
    const mediaElNode = this.closest('.tour-image-info');
    const tourUploader = wp.media({
      title: __('Select Images', 'travel-booking'),
      button: {
  ...
  (0,delegated_events__WEBPACK_IMPORTED_MODULE_1__.on)('click', '.tour-image-info .tour-gallery-remove', function (event) {
    event.preventDefault();
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (tourReviewImages);
...
(() => {
/*!***********************************************************!*\
  !*** ./assets/js/admin/product-review/product-review.tsx ***!
  \***********************************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _images__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./images */ "./assets/js/admin/product-review/images.js");
