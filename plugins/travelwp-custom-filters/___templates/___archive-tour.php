<?php
/**
 * Custom Archive Tour Template
 * Based on theme's archive-tour.php but with pagination support
 */
...
if (get_option(Tour_Settings_Tab_Phys::$_tours_show_page_id)) {
    ...
    <ul class="aasdasd tours products wrapper-tours-slider content_tour_<?php echo esc_attr($item_layout); ?>">
        <?php if (have_posts()) : ?>
