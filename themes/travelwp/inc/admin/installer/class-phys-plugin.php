...
if ( ! class_exists( 'Phys_Plugin' ) ) {
	class Phys_Plugin {
		...
		public function __construct( $slug = '', $is_wporg = false ) {
			...
			$this->messages = array( __( 'Something went wrong!', 'phys-core' ) );
		...
		/**
		 * Get plugin file. Ex: phys-core/phys-core.php
		 *
		 * @since 0.4.0
		 *
		 * @return string
		...
		public function get_text_status() {
			$arrText = array(
				'active'        => __( 'Active', 'phys-core' ),
				'inactive'      => __( 'Inactive', 'phys-core' ),
				'not_installed' => __( 'Not Installed', 'phys-core' )
			);
